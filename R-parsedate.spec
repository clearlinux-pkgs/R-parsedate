...
Version  : 1.3.0
Release  : 27
URL      : https://cran.r-project.org/src/contrib/parsedate_1.3.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/parsedate_1.3.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644866287
